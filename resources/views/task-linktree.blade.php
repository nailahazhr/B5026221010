...
<head>
    <title>KENJIRO | All links you may need</title>
    <link rel="stylesheet" href="task-assets/task.css">
    <script src="https://kit.fontawesome.com/e653fd4117.js" crossorigin="anonymous"></script>
</head>

<body>
    <div class="nailah-bg-image"></div>
    <div class="nailah-bg-text">
        <br>
        <p style="color:rgb(201, 201, 201); letter-spacing: 0.8px; line-height: 0.1px; font-size:12px;">5026221010 |
            Nailah Azzahra</p>
        <br><br>
        <div class="nailah-image-container">
            <img src="task-assets/task.png" alt="kenjiro logo" class="pp" style="width:96px; height:96px;">
        </div>

        <br>
        <h1>KENJIRO</h1>
        <h2>Experience the sights of classic traditional Japanese cuisine in Jakarta</h2>
        <br>

        <p>
            <a class="nailah-contact" href="https://api.whatsapp.com/send?phone=628119209003" target="_blank">
                <i class="fa-brands fa-whatsapp fa-2xl"></i></a>
            &ensp;&ensp;
            <a class="nailah-contact" href="https://www.tiktok.com/@kenjiro.jkt/" target="_blank">
                <i class="fa-brands fa-tiktok fa-2xl"></i></a>
            &ensp;&ensp;
            <a class="nailah-contact" href="https://www.instagram.com/kenjiro.jkt/" target="_blank">
        ...
        <a class="nailah-tile"
            href="https://www.erestaurants.co/modules/booking/book_form_section.php?redirect=1&data=&bkrestaurant=ID_JK_R_TanKenjiro&bktracking=INSTAGRAM"
            target="_blank" ;>
            <div class="icon"></div>
            <p>RESERVASI</p>
            <div class="tile-share-button" link="">
        ...
        <a class="nailah-tile" href="https://drive.google.com/file/d/1-HLv4ttrLOrkv3cDM3YtoPLQQtTAgBRB/view" target="_blank" ;>
            <div class="icon"></div>
            <p>MENU</p>
            <div class="tile-share-button" link="">
                <svg xmlns="http://www.w3.org/2000/svg" height="1em"
        ...
        <a class="nailah-tile"
            href="https://www.grab.com/id/download/?pid=inappsharing&c=6-C2U1RJNVEGMHJ2&is_retargeting=true&af_force_deeplink=true"
            target="_blank" ;>
            <div class="icon"></div>
            <p>GRABFOOD</p>
        ...
        <a class="nailah-tile"
            href="https://www.google.com/maps/place/Kenjiro+Jakarta/@-6.2416794,106.8019134,17z/data=!3m1!4b1!4m6!3m5!1s0x2e69f118d1042f79:0xca0532febb395f80!8m2!3d-6.2416794!4d106.8044883!16s%2Fg%2F11k5fdrsg7?newwindow=1&output=search&q=kenjiro&source=lnms&sa=X&ved=2ahUKEwiq8sDMqbuAAxUL-jgGHSkPBUIQ0pQJegQICxAB&entry=tts&shorturl=1"
            target="_blank" ;>
            <div class="icon"></div>
            <p>LOCATION</p>
            <div class="tile-share-button" link="https://bytes.dev/?r=ania">
        ...
        <br><br>
        <a href="https://linktr.ee/?utm_source=linktree&utm_medium=profile&utm_content=kenjiro2" target="_blank" ;><svg
                height="20px" viewBox="0 0 80 17" style="display:block;width:auto" fill="none"
